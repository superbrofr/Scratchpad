...
/**
* A puzzle solver using the greedy best-first search (GBFS) algorithm.
* @author Charlotte Pierce
*/
public class GBFS extends GenericSolver
{
  /**
  * Creates a greedy best-first search solver.
  ...
  */
  public GBFS(int[][] startState, int[][] goalState, String aMethod, String aFileName)
  {
