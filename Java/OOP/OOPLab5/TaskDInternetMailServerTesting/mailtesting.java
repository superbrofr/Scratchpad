...
public class mailtesting extends junit.framework.TestCase
{
	...
	public void testDirectMail()
	{
		...
		MailClient bob = new MailClient(mailServ1, "bob", "mailServ1");
		MailClient fred = new MailClient(mailServ2, "fred", "mailServ2");
		bob.sendMailItem("fred@mailServ2", "wasup fred");
		assertEquals(1, mailServ2.howManyMailItems("fred@mailServ2"));
	}
